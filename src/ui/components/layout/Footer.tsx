                     ...
                     <div className="flex h-10 gap-1 items-center">
                        ...
                        <div className="flex-1 flex p-1 gap-1 items-center">
                           <button type="button" aria-label="v0.1.0"
                              ...
                              pointer-events-none transition duration-200 ease-in-out cursor-pointer overflow-hidden select-none [&amp;>[data-pc-name=badge]]:min-w-4 
                              [&amp;>[data-pc-name=badge]]:h-4 [&amp;>[data-pc-name=badge]]:leading-4">
                              <span className="duration-200 font-medium flex-1" >v0.52.0 (Latest)</span></button>
